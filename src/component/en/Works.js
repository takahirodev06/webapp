...
function Works_En(props) {

    useEffect(() => {
        document.title = 'Work | TAKAHIRO YAMADA WEB CREATION';
        window.scroll({
            top: 0,
            // behavior: "smooth",
        });
    ...
    return (
        <div className="sub_container">
            ...
            <section className="works_box">
                <div className="work_item">
                    ...
                    <div className="work_detail">
                     ...
                     <p><a target="_blank" href="https://hirokikuroda.fr/"
                              className={"visitsite"}><span>Visit this page</span></a>
                        </p>
                    </div>
                </div>
                ...
                <div className="work_item"><h3 className="hide_pctab">Erika BEAUMEL | Psychologue et Coach
                    spirituelle</h3>
                    ...
                    <div className="work_detail">
                        ...
                        <p><a target="_blank" href="https://erikabeaumel-yamamoto.fr/"
                              className={"visitsite"}><span>Visit this page</span></a>
                        </p>
                    </div>
                </div>
                ...
                <div className="work_item"><h3 className="hide_pctab">Yukiyo Nomura | Coach professionnel</h3>
                    ...
                    <div className="work_detail ">
                        ...
                        <p><a target="_blank" href="shiawasenakaigaiseikatsu.com/"
                              className={"visitsite"}><span>Visit this page</span></a>
                        </p>
                    </div>
                </div>
