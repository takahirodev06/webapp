...
function TopPage_Jp(props) {
    ...
    return (
        <div className="top_container jp">
            ...
            <section className="top_navi">
                <ul>
                    ...
                    <Link to="/jp/services">
                        <li>Services <span> サービス</span></li>
                    </Link>
                    <Link to="/jp/works">
                        <li>Work <span> 実績</span></li>
                    </Link>
                    <Link to="/jp/about">
                        <li>About <span> プロフィール</span></li>
                    </Link>
                    {/*<Link to="/jp/blog">*/}
                    {/*    <li>Blog<span> -プロフィール</span></li>*/}
                    {/*</Link>*/}
                    <Link to="/jp/contact">
