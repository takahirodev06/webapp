...
function Works(props) {
    ...
    useEffect(() => {
        document.title = 'Projets | TAKAHIRO YAMADA WEB CREATION';
        window.scroll({
        ...
        <section className="works_box">
            <div className="work_item">
                ...
                <div className="work_detail">
                    ...
                    <p><a target="_blank" href="https://hirokikuroda.fr/"
                          className={"visitsite"}><span>Voir cette page</span></a></p>
                </div>
            </div>
            ...
            <div className="work_item"><h3 className="hide_pctab">>Atelier Sachiko | Fleuriste design floral à
                ...
                <div className="work_detail">
                    ...
                    <p></p>
                    <p></p>
                    <p><a target="_blank" href="https://ateliersachiko.com/" className={"visitsite"}><span>Voir cette page</span></a>
                    </p>
            ...
            <div className="work_item"><h3 className="hide_pctab">Erika BEAUMEL | Psychologue et Coach spirituelle</h3>
                ...
                <div className="work_detail">
                    ...
                    <p></p>
                    <p></p>
                    <p><a target="_blank" href="https://erikabeaumel-yamamoto.fr" className={"visitsite"}><span>Voir cette page</span></a>
                    </p>
            ...
            <div className="work_item">
                <h3 className="hide_pctab">Yukiyo Nomura | Coach professionnel</h3>
                <div className="work_thumbnail">
